...
*/
int proc_table_diff(proc_entry_t* proc_table_1, int proc_entries_1,
                    ...
                    proc_entry_t* proc_table_3, int* proc_entries_3)
{
    ...
    if (proc_table_1 == NULL || proc_table_2 == NULL ||
        proc_table_3 == NULL || proc_table_3 == proc_table_1 ||
        proc_table_3 == proc_table_2 || proc_entries_3 == NULL ||
        *proc_entries_3 == 0)
    {
...
void proc_table_dump(const proc_entry_t* proc_table, int proc_entries)
{
    ...
    for (i = 0; i < proc_entries; i++)
        printf("%6d %-20s %6lu %6lu %4ld %4ld\n",
               ...
               proc_table[i].utime, proc_table[i].stime,
               proc_table[i].priority, proc_table[i].nice);
