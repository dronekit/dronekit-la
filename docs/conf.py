...
project = u'DroneKit LA (Log Analyser)'
...
exclude_patterns = ['_build','_tests']
...
latex_documents = [
  ('index', 'DroneKit.tex', u'DroneKit LA Documentation',
   u'Hamish Willeer', 'manual'),
]
...
man_pages = [
    ('index', 'dronekit-la', u'DroneKit Log Analyser Documentation',
     [u'Hamish Willee'], 1)
]
...
texinfo_documents = [
  ('index', 'DroneKit-LA', u'DroneKit-LA Documentation',
   u'Hamish Willee', 'DroneKit', 'One line description of project.',
   'Miscellaneous'),
]
